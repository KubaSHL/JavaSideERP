...
public class ContractorsConfig {
    ...
    CommandLineRunner commandLineRunnerContractor(
        ...
        return  args -> {
            Contractor c1 = new Contractor("testName1",  Arrays.toString("testName1".getBytes()), "9018293801" );
            Contractor  c2 = new Contractor("testName2", Arrays.toString("testName2".getBytes()), "88432051");
